...
class EditMeasurnment extends StatefulWidget {
  final String id;
  ...
  @override
  State<EditMeasurnment> createState() => _EditMeasurnmentState();
}

class _EditMeasurnmentState extends State<EditMeasurnment> {
  ...
  void initState() {
    ...
    super.initState();
    productController.text = widget.product;
